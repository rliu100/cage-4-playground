...
class Submission:
    ...
    AGENTS: dict[str, BaseAgent] = {
        f"blue_agent_{agent}": Agent(f'Agent{agent}', Policy.from_checkpoint(os.path.dirname(f'/Users/rll249/Documents/CAGE/cage-4-playground/Submissions/mask_results_2024-04-16_23:22:34/staging/policies/Agent{agent}/'))) for agent in range(5)
    }
