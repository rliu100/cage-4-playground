...
class Submission:
    ...
    AGENTS: dict[str, BaseAgent] = {
        f"blue_agent_{agent}": Agent(f'Agent{agent}', Policy.from_checkpoint(os.path.dirname(f'/Users/rll249/Documents/CAGE/cage-4-playground/Submissions/mask_results_50_2024-04-17_02:24:21/staging/policies/Agent{agent}/'))) for agent in range(5)
    }
