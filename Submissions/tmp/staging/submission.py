...
class Agent(BaseAgent):
    ...
    def get_action(self, observation: dict, action_space: Space):
        return self.model.compute_single_action(observation)
...
class Submission:
    ...
    AGENTS: dict[str, BaseAgent] = {
        ...
        f"blue_agent_{agent}": Agent(Policy.from_checkpoint(os.path.dirname(f'/Users/rll249/Documents/CAGE/cage-4-playground/Submissions/tmp/staging/policies/Agent{agent}/'))) for agent in range(5)
    }
